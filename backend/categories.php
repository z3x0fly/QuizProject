...
if (isset($_SESSION['id']))
{
    ...
    $tablocek=$categoryQuery-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Kategoriler (Dersler)</h4>
                        <div class="clearfix"></div>
                        <?php
                        if (isset($_GET['ekle'])) {
                          // code...
                          ...
                          try {
                             ...
                             $sorgula = $con->prepare("INSERT INTO categories(name) VALUES(?)");
                            ...
                            //echo $ad,$soyad,$pass_enc, $mail, $tarih, $sinif;
                              ...
                              <div class="alert alert-success alert-dismissible fade in">
                                                                          ...
                                                                          Kategori (Ders) Başarılı Şekilde Eklendi. Yenileniyor !
                                                                      </div>
                                                              <?php
                        ...
                        if(isset($_GET['sil']))
                        {
                          $sorgu=$con->prepare('DELETE FROM categories WHERE id=?');
                            $sonuc=$sorgu->execute([$_GET['sil']]);
                            if($sonuc){
                              echo '  <div class="alert alert-success alert-dismissible fade in">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                              Kategori (Ders) Başarılı Şekilde Silindi. Yenileniyor !
                              </div>';
                              header('refresh:2;url=categories.php');
                            }
                            else
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Ders (Kategori) Ekle</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <h3 class="header-title m-t-0"><small></small></h3>
                                             ...
                                             <form action="categories.php?ekle" method="post">
                                                    <div class="form-group">
                                                        <label>Kategori (Ders) Adı</label>
                ...
                <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Eklenmiş Kategoriler (Dersler) Tablosu</h3>
                                    </div>
                                    <div class="panel-body">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                              ...
                                              <td> <a type="button" href="categories.php?sil=<?= $cek->id ?>"><button class="btn btn-danger waves-effect waves-light">Kategoriyi (Dersi) Sil</button></a></td>
