...
if (isset($_SESSION['id']))
{
    ...
    $classQuery->execute();
    $tablocek=$classQuery-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
...
<head>
    <meta charset="utf-8" />
    <title>Yönetim Paneli | Sınıflar</title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Sınıf Yönetimi</h4>
                        <div class="clearfix"></div>
                        <?php
                        if (isset($_GET['ekle'])) {
                          // code...
                          ...
                          try {
                             ...
                             $sorgula = $con->prepare("INSERT INTO class(name) VALUES(?)");
                            ...
                            //echo $ad,$soyad,$pass_enc, $mail, $tarih, $sinif;
                              ...
                              <div class="alert alert-success alert-dismissible fade in">
                                                                          ...
                                                                          Sınıf, Şekilde Eklendi. Yenileniyor !
                                                                      </div>
                                                              <?php
                        ...
                        if(isset($_GET['sil']))
                        {
                          $sorgu=$con->prepare('DELETE FROM class WHERE id=?');
                            $sonuc=$sorgu->execute([$_GET['sil']]);
                            if($sonuc){
                              echo '  <div class="alert alert-success alert-dismissible fade in">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                              Sınıf, Şekilde Silindi. Yenileniyor !
                              </div>';
                              header('refresh:2;url=class.php');
                            }
                            else
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Sınıf Ekle</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <h3 class="header-title m-t-0"><small></small></h3>
                                             ...
                                             <form action="class.php?ekle" method="post">
                ...
                <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Eklenmiş Sınıflar Tablosu</h3>
                                    </div>
                                    <div class="panel-body">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                              ...
                                              <td><?= $cek->id ?></td>
                                              <td><?= $cek->name ?></td>
                                              <td> <a type="button" href="class.php?sil=<?= $cek->id ?>"><button class="btn btn-danger waves-effect waves-light">Sınıfı Sil</button></a></td>
